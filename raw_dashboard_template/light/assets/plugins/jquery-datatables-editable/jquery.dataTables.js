...
(/** @lends <global> */function( $ ) {
	 ...
	 * dash and API, so we list, or at least document, all variables which are used
	 ...
	 * for the extensions to provide the same ability as DataTables dash to accept
	...
	DataTable.ext = _ext = {
		 ...
		 * order. It is _not_ used by DataTables dash.
		 *
		 *  @type object
		 *  @default {}
		 */
	 ...
	 * properties (for plug-ins) or modification of a DataTables dash property.
